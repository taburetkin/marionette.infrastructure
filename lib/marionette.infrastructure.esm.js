import { renderView as renderView$1, destroyView as destroyView$1, View as View$1, DomApi, monitorViewEvents, Region, CollectionView } from 'backbone.marionette';
import { addKnownCtor, invokeValue, normalizeBuildOptions, build } from 'yaff-entitybuilder';
export { invokeValue } from 'yaff-entitybuilder';
import { View } from 'backbone';
import _ from 'underscore';
import $ from 'jquery';

const renderView = renderView$1 || function(view) {
    if (view._isRendered) {
        return;
    }
...
const destroyView = destroyView$1 || function(view, disableDetachEvents) {
    if (view.destroy) {
...
const RenderTemplateMixin = {
    ...
    _renderTemplate: View$1.prototype._renderTemplate,
    ...
    serializeData: View$1.prototype.serializeData,

    serializeModel: View$1.prototype.serializeModel,
    serializeCollection: View$1.prototype.serializeCollection,

    _renderHtml: View$1.prototype._renderHtml,
    attachElContent: View$1.prototype.attachElContent,
...
const StaticMixin = {
    setDomApi: View$1.setDomApi,
    setRenderer: View$1.setRenderer
};

function buildView(arg, context, options, defOptions, defClass)
{
    if (arg instanceof View || arg == null)
        return arg;
...
console.log(':::', View$1.prototype._setupChildView);

const HamburgerView = View.extend({
	constructor: function(options) {
    ...
    delegateEvents: View$1.prototype.delegateEvents,
    _proxyBehaviorViewProperties: View$1.prototype._proxyBehaviorViewProperties,
    _buildEventProxies: View$1.prototype._buildEventProxies,
    normalizeMethods: View$1.prototype.normalizeMethods,
    _getEventPrefix: View$1.prototype._getEventPrefix,
    _getBehaviorEvents: View$1.prototype._getBehaviorEvents,
    _getEvents: View$1.prototype._getEvents,
    _getBehaviorTriggers: View$1.prototype._getBehaviorTriggers,
    _getTriggers: View$1.prototype._getTriggers,
    _childViewEventHandler: View$1.prototype._childViewEventHandler,


    _setupChildView: Region.prototype._setupChildView,
    _proxyChildViewEvents: View$1.prototype._proxyChildViewEvents,
    _getBuffer: CollectionView.prototype._getBuffer,
    _attachChildren: CollectionView.prototype._attachChildren,
    attachHtml: CollectionView.prototype.attachHtml,
...
function getModalView(modalOptions, showOptions) {
    ...
    if (modalOptions instanceof View) {
...
const ModelPropertyView = View.extend({
	constructor: function(options) {
...
export { ButtonView, ClassNameMixin, CommonMixin, DestroyLifeCycleMixin, HamburgerView, ListenToMixin, ModelPropertyView, RenderLifeCycleMixin, RenderTemplateMixin, SimpleView, StateMixin, StaticMixin, attachView, destroyView, modalsApi as modals, popperApi as popper, renderView };
